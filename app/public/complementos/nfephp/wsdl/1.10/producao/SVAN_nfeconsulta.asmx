...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  ...
  <wsdl:portType name="NfeConsultaSoap">
    <wsdl:operation name="nfeConsultaNF">
      <wsdl:documentation xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">Serviço destinado ao atendimento de solicitações de consulta da situação atual da 
NF-e na Base de Dados do Portal da Sefaz Virtual do Ambiente Nacional</wsdl:documentation>
  ...
  <wsdl:service name="NfeConsulta">
    <wsdl:port name="NfeConsultaSoap" binding="tns:NfeConsultaSoap">
      <soap:address location="https://www.sefazvirtual.fazenda.gov.br/nfeconsulta/nfeconsulta.asmx" />
    </wsdl:port>
    <wsdl:port name="NfeConsultaSoap12" binding="tns:NfeConsultaSoap12">
      <soap12:address location="https://www.sefazvirtual.fazenda.gov.br/nfeconsulta/nfeconsulta.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>