...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeCancelamento" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeCancelamento" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
  ...
  <wsdl:service name="NfeCancelamento">
    <wsdl:port name="NfeCancelamentoSoap" binding="tns:NfeCancelamentoSoap">
      <soap:address location="https://www.sefazvirtual.fazenda.gov.br/NFeCancelamento/NFeCancelamento.asmx" />
    </wsdl:port>
    <wsdl:port name="NfeCancelamentoSoap12" binding="tns:NfeCancelamentoSoap12">
      <soap12:address location="https://www.sefazvirtual.fazenda.gov.br/NFeCancelamento/NFeCancelamento.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>